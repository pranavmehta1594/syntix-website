...
export function HeroSection() {
    ...
    return (
        <section className="relative min-h-[80vh] lg:min-h-[85vh] flex flex-col justify-center overflow-hidden bg-background">
            ...
            {/* Subtle Grid overlay */}
            <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:linear-gradient(to_right,black_20%,transparent_80%)] pointer-events-none" />
            ...
            <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-20 lg:pt-28 pb-32 flex w-full">
                ...
                <div className="w-full lg:w-[60%] flex flex-col items-start text-left">
                    ...
                    {/* Premium Badge */}
                    <div
                        className={`mb-6 inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-foreground/10 bg-foreground/5 backdrop-blur-md transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                            }`}
                    >
                    ...
                    <div className="mb-6 w-full">
                        <h1
                            className={`text-[clamp(2.5rem,5vw,4.5rem)] font-display leading-[1.05] tracking-tight transition-all duration-1000 delay-100 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                                }`}
                        >
                            We engineer premium
                            <br />
                    ...
                    {/* Description */}
                    <p
                        className={`text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl mb-10 transition-all duration-1000 delay-200 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
                            }`}
                    >
                    ...
                    >
                        <Button
                            size="lg"
                            className="relative bg-foreground hover:bg-foreground/90 text-background px-8 h-12 lg:h-14 lg:px-10 text-base rounded-full group overflow-hidden"
                        >
                        ...
                        <Button
                            size="lg"
                            variant="outline"
                            className="h-12 lg:h-14 px-8 lg:px-10 text-base rounded-full border-foreground/20 hover:bg-foreground/5 bg-background/50 backdrop-blur-md"
                        >
                            View Our Work
                        </Button>
                    </div>
            ...
            <div
                className={`absolute bottom-0 left-0 right-0 border-t border-foreground/10 bg-background/40 backdrop-blur-xl transition-all duration-1000 delay-500 py-4 lg:py-6 z-20 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                    }`}
            >
                            ...
                            <div key={i} className="flex gap-24">
                                {[
                                    ...
                                    <div key={`${stat.company}-${i}`} className="flex items-center gap-4">
                                        ...
                                        <span className="text-xs lg:text-sm text-muted-foreground flex flex-col justify-center">
                                            {stat.label}
                                            <span className="font-mono text-[9px] lg:text-[10px] uppercase tracking-widest text-foreground/40">{stat.company}</span>
                                        </span>
                                    </div>
                                ))}
                            </div>
